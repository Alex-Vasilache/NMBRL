...
from world_models.dmc_cartpole_wrapper import DMCVecEnvWrapper as VecEnvWrapper
from world_models.dmc_cartpole_wrapper import DMCWrapper as SingleEnvWrapper
...
class ActorCriticTrainer:
    ...
    def __init__(self, config):
        ...
        """
        self.config = config
        self.world_model = VecEnvWrapper(
            batch_size=config.get("batch_size"),
            max_episode_steps=config.get("max_steps_per_episode"),
        )
        self.eval_env = SingleEnvWrapper(
    ...
    def train(self):
        ...
        for epoch in range(num_epochs):
            ...
            if eval_frequency and (epoch + 1) % eval_frequency == 0:
    ...
    def run_intermediate_evaluation(self, epoch):
        ...
        original_render_mode = self.eval_env.render_mode
        ...
        try:
            ...
            self.eval_env.render_mode = original_render_mode
...
if __name__ == "__main__":
    ...
    tools.seed_everything(training_config["seed"])
